#!/usr/bin/env python
"""MPS H2O QC script-generation example."""

from __future__ import annotations

from aiida import load_profile, orm

from aiida_renormalizer.calcfunction.calcfunction_mps_h2o_qc import (
...
# CALC
WORKFLOW_NAME = "h2o_qc_dmrg"
METHOD = "2site"


def main() -> None:
    input_params = {"fcidump_file": FCIDUMP_FILE}
    model_params = {
        "spatial_norbs": SPATIAL_NORBS,
        "nelec": NELEC,
        "m_max": M_MAX,
    }
    calc_params = {
