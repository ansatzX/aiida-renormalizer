#!/usr/bin/env python
"""MPS FMO script-generation example."""

from __future__ import annotations

from aiida import load_profile, orm

from aiida_renormalizer.calcfunction.calcfunction_mps_fmo import (
...
# CALC
WORKFLOW_NAME = "fmo_charge_diffusion"
EVOLVE_DT = 160
EVOLVE_TIME = 40000


def main() -> None:
    input_params = {"sdf_file": SDF_FILE}
    model_params = {"n_phonons": N_PHONONS, "total_hr": TOTAL_HR}
    calc_params = {
