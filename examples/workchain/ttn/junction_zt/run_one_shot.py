#!/usr/bin/env python
"""TTN junction zero-temperature case migrated from ori_examples/ttns/junction_zt.py."""
...
INPUT = {
    ...
    "electrode": {"n_e_mode": 80, "beta_e": 1.0, "alpha_e": 0.2, "bias_v": 0.1},
}
BUILD = {"temperature": 0.0, "initial_occupied": True, "tree_type": "binary", "m_max": 20}
RUN = {"dt": 0.2, "nsteps": 100, "method": "tdvp_ps"}
