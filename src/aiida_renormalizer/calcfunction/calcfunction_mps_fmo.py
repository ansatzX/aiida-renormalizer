"""MPS FMO case-scoped calcfunctions."""
        ...
        [
            {
                ...
                "script": _render_stage_script(
                    "mps_fmo_write_generated_script_stage.py.jinja",
                    {"output_path": output_path, "script_text_b64": script_text_b64},
                ),
            },
            {
                "name": "compile_generated_script",
                "script": _render_stage_script("mps_fmo_compile_generated_script_stage.py.jinja", {"output_path": output_path}),
            },
        ]
    )
...
@calcfunction
def mps_fmo_script(input_params: orm.Dict, model_params: orm.Dict, calc_params: orm.Dict, real_run: orm.Bool) -> orm.Dict:
    return orm.Dict(
        dict=_render_case_script_payload(
            template_name="example_mps_fmo_single_file.py.jinja",
            script_name="mps_fmo_generated.py",
...
build_mps_script = mps_fmo_script
