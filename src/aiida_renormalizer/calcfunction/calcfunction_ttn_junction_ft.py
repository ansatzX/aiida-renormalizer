"""TTN junction FT case-scoped calcfunctions."""
    ...
    stages = [
        {
            ...
            "script": _render_stage_script(
                "ttn_junction_ft_write_generated_script_stage.py.jinja",
        ...
        },
        {
            ...
            "script": _render_stage_script(
                "ttn_junction_ft_compile_generated_script_stage.py.jinja",
...
@calcfunction
def ttn_junction_ft_script_from_spec_topology(
    input_params: orm.Dict,
    model_params: orm.Dict,
    calc_params: orm.Dict,
    op_spec,
    ...
    return orm.Dict(
        dict=_render_case_script_from_spec_topology_payload(
            template_name="example_ttn_junction_ft_from_spec_topology_single_file.py.jinja",
            script_name="ttn_junction_ft_generated.py",
...
build_ttn_script = ttn_junction_ft_script_from_spec_topology
